...
import 'undergraduate_job_details.dart';

class UndergraduateJobSearchDelegate extends SearchDelegate {
  final String category;

  UndergraduateJobSearchDelegate({required this.category});
        ...
        return ListTile(
          ...
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => UndergraduateJobDetails(
                  job: job, // Pass the job data here
                ),
              ),
            );
          },
