...
import 'undergraduate_apply_now_form.dart'; // Import the new form

class UndergraduateJobDetails extends StatelessWidget {
  final Map<String, dynamic> job;

  UndergraduateJobDetails({required this.job});
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => UndergraduateApplyNowForm(
                      job: job,
  ...
  String _formatDate(dynamic field) {
    ...
    if (field is Timestamp) {
      return field.toDate().toLocal().toString();
    }
