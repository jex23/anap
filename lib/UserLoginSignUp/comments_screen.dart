...
class _CommentsScreenState extends State<CommentsScreen> {
    ...
    if (user != null) {
      try {
        DocumentSnapshot userDoc = await FirebaseFirestore.instance
            .collection('Applicants') // Change collection name as needed
            .doc(user!.uid)
            .get();
        if (userDoc.exists) {
  ...
  Future<void> _submitComment() async {
    ...
    try {
      ...
      setState(() {
        replyingToCommentId = null; // Reset reply ID after submission
      });
    } catch (e) {
                                  ...
                                  TextButton(
                                    onPressed: () {
                                      setState(() {
                                        ...
                                        _commentController.text = ''; // Clear text field for reply
                                      });
                                    },
